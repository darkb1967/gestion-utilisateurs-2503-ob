...
INSERT INTO candidats (lastname_user, firstname_user, email_user, hashedPassword, department_user, age_user, archive_user) VALUES
...
ALTER TABLE candidats ADD constraint fk_deptuser FOREIGN KEY (department_user) REFERENCES departments(id_dep);
